package com.james.ad.dump;

public class DConstant {

    public static final String DATA_ROOT_DIR = "/Users/jameszyx/GitHub/ad-spring-cloud/ad-spring-cloud/mysql_data";
    ...
    public static final Object AD_UNIT = "ad_unit_data";
}
